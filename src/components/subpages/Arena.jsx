...
const Arena = () => {
  ...
  const blueClass = clsx(basePokeCard, blueWarrior === losser ? "filter grayscale opacity-50" : "");
  const redClass = clsx(basePokeCard, redWarrior === losser ? "filter grayscale opacity-50" : "");
